          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full px-4 py-2.5 pr-12 bg-[#0d1117] border border-white/10 rounded-xl text-white text-sm placeholder-gray-600 focus:outline-none focus:border-[#52b788] transition-colors"
                placeholder="••••••••"
              />
              <button
                type="button"
